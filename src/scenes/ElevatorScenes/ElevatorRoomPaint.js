class ElevatorRoomPainted extends Phaser.Scene {
        ...
        this.canvas1.on('pointerdown', () => {
            if (this.canvas1Clicks < 3) {
                switch (this.canvas1Clicks) {
                    case 0:
                        //You must write what the NEXT painting will be of in this changeDescription
         ...
         this.canvas2.on('pointerdown', () => {
            if (this.canvas2Clicks < 3) {
                switch (this.canvas2Clicks) {
                    case 0:
                        //You must write what the NEXT paintings will be of in this changeDescription
    ...
    update(time, delta){
        //Might want to add the elevatorDoorOpen bool to this if to make it only run once, this may add lots of tweens making performance issues. Resolved :) Thx Michael
