class MirrorShardCloseUp extends Phaser.Scene
{
    ...
    create(){
        ...
        //add the portal bg and letter hand
    ...
    typewriterEffect(fullText) {
        ...
        let index = 0;  //index is where the typewriter is currently typing
        const speed = 10; //the bigger the speed the slower the typewriter effect
