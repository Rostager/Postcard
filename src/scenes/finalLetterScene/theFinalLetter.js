...
class TheFinalLetter extends Phaser.Scene {
    ...
    create() {
        //Need to setCursor because the Ui scene hids it
        this.input.setDefaultCursor('')
        //Kill UI Scene for full scene effect
    ...
    //the index of the string array
    let index = 0;
    //Speed / delay between letters (higher = slower typing)
    const speed = 50;
